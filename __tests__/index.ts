...
import { otherPlayer, playerToString, scoreWhenForty, scoreWhenPoint, scoreWhenAdvantage, scoreWhenDeuce } from '..';
import * as fc from 'fast-check';
import * as G from './generators';
import { deuce, forty, advantage, game, Point, thirty } from '../types/score';
